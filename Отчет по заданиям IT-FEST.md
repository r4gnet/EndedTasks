...
Выдает фотографии похожих мест и мы видим что название здания не то, однако, в режиме панорамы мы можем спококйно найти нужное место с нужным ракурсом неподалеку от Warsaw Marriot Hotel. Задание выполнено.
